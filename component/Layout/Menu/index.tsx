...
return (   
    ...
    <div className="">
      <div className="flex  items-center justify-between ">
          <div className="flex gap-2 pl-3 border-b-3 basis-1/3 border-white hover:border-b-3 hover:border-orange-500 py-2 focus:border-b-3 focus:border-orange-500 text-gray-500 hover:text-orange-500" tabIndex={0}>
             <p>Tất cả</p>
          </div>
          <div className="flex gap-2 pl-3 border-b-3 basis-1/3 border-white hover:border-b-3 hover:border-orange-500 py-2 focus:border-b-3 focus:border-orange-500 text-gray-500 hover:text-orange-500"tabIndex={0}>
